...
fn add(
    ...
    requires
        ((((((inv_matrix_Boolean(x63, x64 as int, x65 as int)) && (inv_matrix_Boolean(
            ...
            (forall|x122: i32|
                (((((0 <= x121) && (x121 < (x70 * x71))) && ((0 <= x122) && (x122 < (x64
                    * x65))))) as int != 0 ==> (true) as int != 0))) && (forall|x136: i32|
            (forall|x137: i32|
                (((((0 <= x136) && (x136 < (x70 * x71))) && ((0 <= x137) && (x137 < (x67
    ...
    ensures
        ((((inv_matrix_Boolean(x63, x64 as int, x65 as int)) && (inv_matrix_Boolean(
            ...
            x63@[(x157) as int] || x66@[(x157) as int]))) as int != 0))),
{
    assert(true);
    assert(true);
    let x73: i32 = x70 * x71;
    ...
    while x81 < x73
        invariant
            ...
            (forall|x82: i32|
                ...
                x82) as int] || x66@[(x82) as int]))) as int != 0)),
        decreases x73 - x81,
    {
...
fn scalar_mult(
    ...
    requires
        ((((inv_matrix_Boolean(x172, x173 as int, x174 as int)) && (inv_matrix_Boolean(
            ...
            (forall|x214: i32|
                (((((0 <= x213) && (x213 < (x176 * x177))) && ((0 <= x214) && (x214 < (x173
    ...
    ensures
        ((((inv_matrix_Boolean(x172, x173 as int, x174 as int)) && (inv_matrix_Boolean(
            ...
            x171 && x172@[(x233) as int]))) as int != 0))) && (((x171 == false)) as int != 0 ==> ((
        forall|x247: i32|
            ((0 <= x247 < x176)) as int != 0 ==> ((forall|x250: i32|
                ((0 <= x250 < x177)) as int != 0 ==> ((x175@[(((x247 * x177) + x250)) as int]
                    == false)) as int != 0)) as int != 0)) as int != 0)),
{
    ...
    while x184 < x179
        invariant
            0 <= x184 <= x179,
            (forall|x185: i32|
                ((((0 <= x185) && (x185 < x184))) as int != 0 ==> ((x175@[(x185) as int] == (x171
                    && x172@[(x185) as int]))) as int != 0)),
        decreases x179 - x184,
    {
        let x197: i32;
        if x171 != 0 {
